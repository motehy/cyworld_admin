package com.cyworld.admin.config;

import com.cyworld.admin.support.AdminInterceptor;
...
//    }
	...
	@Bean
	public AdminInterceptor frontIntercceptor() { //FrontInterceptor @Autowired 사용하기 위해 bean 으로 추가
